...
public class MyApplicationsPage extends JDialog {
    ...
    public MyApplicationsPage(Frame owner, IApplicationService applicationService, IJobService jobService, Session session) {
        super(owner, "My Applications", true);
    ...
    private void showDetails(Application app) {
        ...
        try {
            ...
            sb.append("Applied: ").append(app.getApplicationDate() != null ? df.format(app.getApplicationDate()) : "N/A").append("\n");
            sb.append("Cover Letter: \n").append(app.getCoverLetter());
            details.setText(sb.toString());
            details.setCaretPosition(0);
        } catch (Exception ex) {
            details.setText("Error loading job details: " + ex.getMessage());
        }
    }
