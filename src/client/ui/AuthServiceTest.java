...
public class AuthServiceTest {
    ...
    private void registerUser() {
        try {
            ...
            System.out.println("\n📤 Registering user...");
            String userId = service.register(email, password, role, name);
            ...
            if (userId != null && !userId.isEmpty()) {
                ...
                System.out. println("   - Password too short (min 6 chars)");
            }
    ...
    private void changePassword() {
        try {
            ...
            String userId = InputHelper.getString();
            ...
            System.out.println("\n📤 Changing password...");
            boolean changed = service.changePassword(userId, oldPassword, newPassword);
    ...
    private void validateSession() {
        try {
            ...
            String token = InputHelper.getString();

            System.out.println("\n📤 Validating session...");
            Session session = service.validateSession(token);

            if (session != null) {
                if (session.isExpired()) {
                    System. out.println("⚠️  Session is EXPIRED!\n");
                    System.out.println("Session Details:");
                    System.out. println("  Token: " + session.getSessionToken());
                    System.out.println("  Email: " + session.getEmail());
                    System.out.println("  Expired: " + session.getExpiresAt());
                    System.out.println("\n💡 Please login again.");
                } else {
    ...
    private void printUser(User u) {
        ...
        System.out.println("  Profile ID: " + u. getProfileId());
